...
const navigation = {
  adopt: [
    { name: "Available Chinchillas", href: "/adopt" },
    { name: "Apply to Adopt", href: "/apply" },
    { name: "Adoption Process", href: "/about" },
    { name: "Success Stories", href: "/about" },
  ],
  support: [
    { name: "Chinchilla Care Guide", href: "/care" },
    { name: "Contact Us", href: "/contact" },
    { name: "FAQ", href: "/about" },
    { name: "Emergency Resources", href: "/care" },
  ],
  getInvolved: [
    { name: "Volunteer", href: "/volunteer" },
    { name: "Donate", href: "/donate" },
    { name: "Foster Program", href: "/contact" },
    { name: "Spread the Word", href: "/about" },
  ],
  legal: [
    { name: "Adoption Agreement", href: "/contact" },
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-20 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="grid grid-cols-2 gap-8 xl:col-span-2">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-sm font-semibold mb-4">Adoption</h3>
        ...
        <div className="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 md:flex md:items-center md:justify-between lg:mt-24 dark:border-white/10">
          ...
          <p className="mt-8 text-sm/6 text-gray-600 md:order-1 md:mt-0 dark:text-gray-400">
            &copy; {new Date().getFullYear()} Canadian Chinchilla Rescue. All
            rights reserved.
          </p>
        </div>
      </div>
